...
input = "/home/ivoga/Documents/PhD/Landau_Hofstadter/jl2/out_loc/wannier_out/all_hops-ph1-2-U-0.05-a5.0-LL20-NXY121.txt"
# args = ARGS
# if length(args) != 1
...
plot!(plt,kdo.x,kdo.density, label = "original", color = :black, style = :dash, dpi = 300, legend=:top)
