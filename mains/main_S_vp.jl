...
plot_save_folder_path = "/home/ivoga/Documents/PhD/Landau_Hofstadter/jl/plots/local/singleLLs/"
#plot_save_folder_path = "/users/ivoga/lh/plts/spectra"
#data_save_folder_path = ""
#data_save_folder_path = "/users/ivoga/lh/data_LB"

#args = ARGS
args = ["[1.0, 4.0, 0.01, 50, 78, 1]"]
...
# save plots
spectrum_plot_name = string("S_vp_U$U0-a$a_in_angstr-q$q-phi$startphi-phf$endphi-N$NLL")
